...
public class HumanPlayer extends Player {
    ...
    /**
     * Méthode permettant de choisir une ressource
    ...
    /**
     * Méthode permettant de choisir une action
     * @param player le joueur qui choisit l'action
    ...
    public Action chooseAction(Player player, Board board) {
        ...
        while (true) {
            ...
            if (choice.equals("1")) {
                ...
                if (cpt == 4) {
                    Game.display.out.println(
                        " Il ne reste plus assez de jetons, veuillez choisir une autre option entre la 2, la 3 ou la 4\n"
                    );
                    possible.remove("1");
                    choice = "";
                }
            ...
            if (choice.equals("1")) {
                ...
                while (true) {
                    ...
                    if (!notEnough) {
                        ...
                        Game.display.out.println(
                            "Il n'y a plus assez de cette ressource, veuillez en choisir une autre"
                        );
                        notEnough = false;
                    }
                }
            ...
            if (choice.equals("2")) {
                ...
                while (true) {
                    ...
                    if (res1.equals(res2)) {
                        Game.display.out.println(
                            "Vous avez déjà sélectionné cette ressource, veuillez en choisir une autre"
                        );
                    } else {
                        break;
                    }
            ...
            if (choice.equals("3")) {
                ...
                while (true) {
                    ...
                    if (player.canBuyCard(card)) {
                        ...
                        Game.display.out.println(
                            "Vous n'avez pas les ressources suffisantes pour acheter la carte suivante : " +
                            card +
    ...
    public Action chooseDiscardingTokens() {
        if (super.getNbTokens() > 10) {
            ...
            while (nbTokentrop > 0) {
                ...
                if (choice.equals("1")) {
                    Game.display.out.println(
                        "diamond " + super.getNbResource(Resource.DIAMOND)
                    );
                    if (nbDiamond > 0) {
                ...
                if (choice.equals("2")) {
                    Game.display.out.println(
                        "sapphire " + super.getNbResource(Resource.SAPPHIRE)
                    );
                    if (nbSapphire > 0) {
                ...
                if (choice.equals("3")) {
                    Game.display.out.println(
                        "emerald " + super.getNbResource(Resource.EMERALD)
                    );
                    if (nbEmerald > 0) {
                ...
                if (choice.equals("4")) {
                    Game.display.out.println(
                        "ruby " + super.getNbResource(Resource.RUBY)
                    );
                    if (nbRuby > 0) {
                    ...
                    Game.display.out.println(
                        "onyx " + super.getNbResource(Resource.ONYX)
                    );
                    if (nbOnyx > 0) {
